...
function loadAdminAuthConfig(env = process.env) {
  const config = {
    ...
    altchaCost: readInteger(env, 'ADMIN_ALTCHA_COST', 1000, 1000, 100000),
    altchaCounterMin: readInteger(env, 'ADMIN_ALTCHA_COUNTER_MIN', 1000, 1000, 100000),
    altchaCounterMax: readInteger(env, 'ADMIN_ALTCHA_COUNTER_MAX', 2500, 1000, 200000),
