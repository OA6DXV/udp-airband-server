...
function createWebAdmin(options) {
  ...
  function securityHeaders(options = {}) {
    const contentSecurityPolicy = options.googleCharts
      ? "default-src 'self'; script-src 'self' https://www.gstatic.com https://www.google.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://www.gstatic.com https://www.google.com; connect-src 'self' https://www.gstatic.com https://www.google.com; frame-ancestors 'none'; base-uri 'none'; form-action 'self'"
