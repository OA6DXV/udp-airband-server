  ...
  const multiCard = streams.length > 1 ? `
    <button id="multiCard" class="stream multi-card" type="button">
      <span class="stream-main">
        ...
        <span class="stream-meta" data-multi-description>listen multiples frecuencies at the same time.</span>
      </span>
...
<head>
  ...
  <style>
    ...
    .multi-card { grid-template-columns: 1fr; border-color: #ff3d12; text-align: center; }
    .multi-card .stream-main { justify-items: center; }
    .multi-card.selecting, .multi-card.ready { border-color: #394451; }
...
<body>
  ...
  <script>
    const translations = {
      en: { title: 'Real-time Airband audio streams', users: 'Users', lastTransmission: 'Last Transmission', never: 'never', now: 'Now', multiTitle: 'Multi Stream', multiDescription: 'listen multiples frecuencies at the same time.', selectStreams: 'Select streams', startMulti: 'Start Multi Stream' },
