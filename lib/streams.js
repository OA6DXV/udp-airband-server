...
<body class="multi-page">
  <main>
    ...
    <div id="multiModeControls" class="multi-mode-controls" aria-label="audio mode">
      <button id="multiRawMode" class="multi-mode-button" type="button" data-mode="raw">Uncompressed</button>
      <button id="multiCompressedMode" class="multi-mode-button" type="button" data-mode="opus">Compressed</button>
    </div>
  ...
  <div id="multiStartOverlay" class="multi-start-overlay">
    <button id="multiStartButton" class="multi-start-button" type="button" aria-label="Play">
      <span class="multi-start-icon"></span>
      <span>Play</span>
    </button>
  </div>
