...
<body>
  ...
  <script>
    const translations = {
      en: { title: 'Real-time Airband audio streams', users: 'Users', lastTransmission: 'Last Transmission', never: 'never', now: 'Now', multiTitle: 'Multi Stream', multiDescription: 'Listen multiple frequencies at the same time.', selectStreams: 'Select streams', startMulti: 'Start Multi Stream' },
      es: { title: 'Streams de audio Airband en tiempo real', users: 'Usuarios', lastTransmission: 'Ultima transmision', never: 'nunca', now: 'Ahora', multiTitle: 'Multi Stream', multiDescription: 'escucha multiples frecuencias al mismo tiempo.', selectStreams: 'Selecciona streams', startMulti: 'Iniciar Multi Stream' },
    };
