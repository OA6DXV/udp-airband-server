...
<head>
  ...
  <style>
    ...
    .multi-card.ready { border-color: #4fb477; background: #4fb477; color: #07110c; animation: readyPulse 3s ease-in-out infinite; }
    .multi-card.ready .stream-last { color: #07110c; }
    @keyframes selectPulse { 0%, 100% { border-color: #394451; } 50% { border-color: rgb(255 61 18 / 70%); } }
    @keyframes readyPulse { 0%, 100% { opacity: 1; } 50% { opacity: .74; } }
