...
<head>
  ...
  <style>
    ...
    .stream.selecting { animation: selectPulse 1.35s ease-in-out infinite; }
    ...
    .multi-card.ready { border-color: #ff3d12; }
...
<body>
  ...
  <script>
    ...
    function updateMultiSelection() {
      ...
      multiCard.classList.toggle('selecting', selectingMulti);
...
<body class="multi-page">
  ...
  <script id="streamData" type="application/json">${escapeHtml(JSON.stringify({ streams: safeStreams, softwareVersion }))}</script>
