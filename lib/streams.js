...
<head>
  ...
  <title>Realtime Airband Streams</title>
  <style>
    ...
    .active-users, .language-button { min-height: 38px; border: 1px solid #394451; border-radius: 8px; background: #1b2028; color: #9aa7b3; }
    .active-users { display: inline-flex; align-items: center; gap: 8px; padding: 8px 12px; font-size: 14px; }
    .active-users strong { color: #eef2f6; font-size: 15px; }
    .language-switch { position: relative; }
    .language-button { min-width: 66px; display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 0 10px; font: inherit; font-weight: 650; cursor: pointer; }
...
<body>
  <main>
    <header>
      <h1 data-label="title">Realtime Airband Streams</h1>
  ...
  <script>
    const translations = {
      en: { title: 'Realtime Airband Streams', users: 'Users', lastTransmission: 'Last Transmission', never: 'never', now: 'Now' },
      es: { title: 'Streams Airband en tiempo real', users: 'Usuarios', lastTransmission: 'Ultima transmision', never: 'nunca', now: 'Ahora' },
    };
